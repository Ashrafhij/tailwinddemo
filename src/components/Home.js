      ...
      {isLoading ? (
        ...
        >
          ...
          >
            ...
            <p className="text-lg font-bold italic text-right">החיוך המושלם שאנחנו יכולים לתת לך יכול לעזור לך לשפר את התקשורת עם האנשים מסביבך , תמיד תזכור בטחון עצמי הוא הדרך להצלחה, ובטח שחיוך מושלם הוא חלק חשוב מאוד להיות עם בטחון עצמי.</p>
